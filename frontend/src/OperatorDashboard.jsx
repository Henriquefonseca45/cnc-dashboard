                ...
                >
                  ...
                  >
                    {previewData.items.map((item, idx) => {
                      ...
                      if (item.type === "circle") {
                        return <circle key={idx} {...clickProps} cx={item.cx} cy={item.cy} r={item.r} stroke={selected ? "#f97316" : "#bbf7d0"} strokeWidth={selected ? 3 : undefined} />;
                      }
                      if (item.type === "arc") {
                        return <path key={idx} {...clickProps} d={arcPath(item)} stroke={selected ? "#f97316" : "#fde68a"} strokeWidth={selected ? 3 : undefined} />;
                      }
